...
class SearchViewModel(app: Application) : AndroidViewModel(app) {
    ...
    private val publicWebSearch = PublicWebImageSearch(app)
    ...
    val publicWebProviders = PublicWebImageSearch.providers
    ...
    fun runPublicWebSearch(provider: PublicWebImageSearch.Provider) {
        val uri = imageQueryUri ?: return
        publicWebSearch.open(uri, provider)
    }
